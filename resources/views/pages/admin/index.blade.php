                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                @if(empty($benutzer->fachbereich))
                                    <td>nicht vorhanden</td>
                                @else
                                    <td>{{$benutzer->fachbereich}}</td>
                                @endif
                                @if(empty($benutzer->bildungsgrad))
                                    <td>nicht vorhanden</td>
                                @else
                                    <td>{{$benutzer->bildungsgrad}}</td>
                                @endif
                                <td>{{$benutzer->rolle->name}}</td>
                                <td>
                                    <div class="table-actions">
                                        <a href="{{route('admin.edit',[$benutzer->id])}}"><i data-feather="edit"></i></a>
